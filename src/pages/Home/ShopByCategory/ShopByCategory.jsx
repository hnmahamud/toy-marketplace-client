    ...
    <div className="space-y-8 mt-16 md:mt-2 mb-8 md:mb-16">
      <div className="md:w-[70%] md:mx-auto md:text-center space-y-4">
        ...
        <p className="text-gray-500">
          ...
          learning and development. From puzzles and building blocks to science
          kits and language games, our toys foster cognitive abilities,
          problem-solving skills, and creativity. Discover the joy of learning
          through play!
        </p>
      </div>
